        ...
        <section class="space-y-6">
            ...
            <article class="main-border  mx-auto max-w-none px-4 py-5 sm:px-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-shrink-0">
                                <img class="h-10 w-10 rounded-full object-cover" :src="postDetail.user.profileImgUrl"
                                    :alt="postDetail.user.first_name" />
                            </div>
                            </Link>
                            ...
                            <div class="relative inline-block text-left">
                                ...
                                <div v-show="menu.open"
                                    ...
                                    <Link :href="route('posts.edit', postDetail.uuid)"
                                        ...
                                        tabindex="-1" id="user-menu-item-0">Edit
                                    </Link>
                ...
                <div v-if="postDetail.media" class="mt-2 mb-6 space-y-4">
                    <img v-for="img in postDetail.media" :key="img.id" :src="img.original_url" :alt="img.file_name"
                        class="rounded-md">
                </div>
            ...
            <div class="flex flex-col space-y-6">
                ...
                <article v-else class="main-border mx-auto max-w-none px-4 py-2 sm:px-6 min-w-full divide-y">
                    <!-- Comment  -->
