                ...
                <div class="">
                    <template v-for="(notification, index) in userNotifications" :key="index">
                        <Link :href="notification.data.link"
                            class="flex items-center py-1.5 -mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-50 dark1:hover:bg-gray-700 dark1:border-gray-700">
                        <img class="flex-shrink-0 object-cover w-8 h-8 mx-1 rounded-full"
                            :src="notification.data.sender.profileImgUrl"
                            :alt="notification.data.sender.first_name" />
